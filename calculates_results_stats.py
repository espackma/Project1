...
def calculates_results_stats(results_dic):
    ...
    #    
    # Calculates % correct dogs and breed
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_dogs'] = 100*(results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img'])
        results_stats_dic['pct_correct_breed'] = 100*(results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img'])
    else:
